...
class MineSimulator:
    ...
    def _init_grid_from_file(self, grid_file):
        ...
        # --- Build the impassable set directly from the returned lists (much faster) ---
    ...
    def render(self, show_miners=True):
        """
        ...
        if self.render_mode == "human":
            ...
            return self.renderer.render(self.static_grid, world_state, show_miners=show_miners)
